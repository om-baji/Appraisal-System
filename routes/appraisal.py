...
from model.appraisalModel import collection, appraisal_serializer
...
def create_appraisal():
    ...
    try:
        ...
        if 'employee_id' not in session:
            return jsonify({"error": "You must be logged in to create an appraisal"}), 401
...
def update_appraisal(appraisal_id):
    ...
    try:
        ...
        allowed_fields = [
            "appraisal_period", "performance_rating", "goals_achieved", "strengths",
